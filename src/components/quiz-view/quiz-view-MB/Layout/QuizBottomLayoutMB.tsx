...
const QuizBottomLayoutMB: React.FC<QuizBottomLayoutMBProps> = (
  ...
  const arrowStyle = "size-[42px] stroke-icons stroke-2";
  ...
  const listIcon = (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="stroke-icons stroke-[3px]"
    >
      <path
  ...
  return (
    <>
      <div className="fixed bottom-0 z-50 flex w-full flex-row">
        ...
        <div className="i z-0 flex w-full flex-col-reverse">
          <div className="relative h-[20px] w-full overflow-hidden">
            ...
            >
              <div className="h-[20px] w-full rounded-b-full bg-my-background"></div>
            </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 z-20 h-9 w-full bg-gradient-to-t from-my-background to-transparent"></div>
    </>
  );
};
