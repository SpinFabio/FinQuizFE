    ...
    <>
      <motion.div
        ...
        className={classNames(
          "shadow-my-shadow-on-bg/40 my-2 flex flex-row items-center rounded-lg border border-my-border-color p-2 font-roboto text-quiz-mb font-body-mb shadow-lg",
