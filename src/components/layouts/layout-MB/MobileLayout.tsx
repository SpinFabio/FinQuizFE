...
const MobileLayout: React.FC<MobileLayoutProps> = () => {
  ...
  const menuButtons: MenuButton[] = [
    ...
    {
      onActions: currenHook.handleSetFav,
    ...
    {
      onActions: currenHook.handleGetFav,
    ...
    {
      onActions: currenHook.handleOpenTimeModal,
    ...
    <div id="layout" className="h-screen w-screen overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          >
            <TimerMB isInteractable={false} timerHook={currenHook.timerHook} />
          </div>
        </div>
      </div>
