...
const logoutIcon = (
  <svg
    ...
    className="stroke-red-400 stroke-[1.5px]"
  >
    <path
...
const LogoutModalMB: React.FC<LogoutModalMBProps> = (
  ...
  const className =
    "flex flex-row p-4 rounded-full m-1 items-center-center  border-red-400";
  ...
  return (
    <>
      <AnimatedButton maxScale={1.05}>
        <div
          className={classNames(className, "bg-white text-red-500")}
      ...
      <ModalMB isOpen={isOpen} type="appearIn" onClose={handleClose}>
        ...
        >
          <div
            ...
            className="flex flex-col rounded-3xl border border-info bg-white p-4 px-6"
          >
            ...
            <div className="flex w-full flex-row justify-between">
              ...
              <Link to={LOGIN_PAGE_ROUTE}>
                <div
                  className={classNames(
                    buttonClass,
                    "bg-red-400 text-primary-contrast",
                  )}
                >
                  Sì, voglio uscire
                </div>
